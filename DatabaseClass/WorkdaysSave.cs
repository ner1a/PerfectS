...
public class WorkdaysSave
{
    ...
    public async Task<bool> BrandInfoUpdate(int[] shiftCount, int[] mondayShiftWorker, int[] tuesdayShiftWorker, int[] wednesdayShiftWorker, int[] thursdayShiftWorker, int[] fridayShiftWorker, int[] saturdayShiftWorker, int[] sundayShiftWorker)
    {
